...
#### 2. RAPDB
	...
	// 获得各个基因的RNA序列信息
retrieve_seq_from_fasta.pl --format refGene --seqfile ricedb/IRGSP-1.0_genome.fasta ricedb/Os_refGene_rapdb.txt --out ricedb/Os_refGeneMrna_rapdb.fa > ricedb/rapdb_log 2>&1